<template lang="pug">
    v-container.ma-0.pa-0.fill-height.fluid
        ...
        v-row
            v-col.ml-0.pa-0.pl-6(cols="6")
                DataTable3.table_border(site='HK' networkFlowType="packetloss" :bgpList="bgpList2['HK']['C']" :tableData="tableData['HK']" :range="range.china" :loading="loading" )
                DataTable3.mt-3.table_border(site="TW" networkFlowType="packetloss" :bgpList="bgpList2['TW']['C']" :tableData="tableData['TW']" :range="range.china" :loading="loading" )
            v-col.ml-0.pa-0.pl-2(cols="6")
                DataTable3.table_border(site='HK' networkFlowType="packetloss" :bgpList="bgpList2['HK']['G']" :tableData="tableData['HK']" :range="range.global" :loading="loading" )
                DataTable3.mt-3.table_border(site='TW' networkFlowType="packetloss" :bgpList="bgpList2['TW']['G']" :tableData="tableData['TW']" :range="range.global" :loading="loading" )
                DataTable3.mt-3.table_border(site='PH' networkFlowType="packetloss" :bgpList="bgpList2['PH']['G']" :tableData="tableData['PH']" :range="range.global" :loading="loading" )
